> 历史 V2 设计与上线记录。当前代码与运维请参考 [V3-UPGRADE.md](V3-UPGRADE.md)。
...
> 本节已完成项目保留为上线记录；未勾选项是截至 2026-08-29 仍需人工或独立迭代的事项，不与历史重构清单混用。
...
- 回滚操作已形成正式运行手册：Web 问题回滚 Worker Version，V2 数据问题只从 `backups-v2/` 恢复；详见 [OPERATIONS.md §5](OPERATIONS.md#5-回滚手册)。
- [x] 首轮观察期内未删除 V1 KV、V1 图片、V1 备份、V2 预览环境或关键 Worker Version；继续保留至至少稳定满 30 天。
- [ ] 回收站恢复入口、V2 版本历史界面和微信小程序作为上线后独立迭代。
