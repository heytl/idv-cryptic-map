...
const MAP_DATA = [
  ...
  },
  {
    ...
    "direction": "左",
    "name": "左-锤灯笼门（新）",
    "entryImg": "public/entry/左-锤灯笼门.webp",
    "floor1Img": "public/floor1/左-锤灯笼门.webp",
    "floor2Img": "public/floor2/左-锤灯笼门.webp",
    "remarks": "左侧入口，锤子形通道与灯笼状墙体组合结构"
  },
  {
    "id": 8,
    "direction": "右",
  ...
  },
  {
    ...
    "direction": "右",
    "name": "右-三L门（新）",
    "entryImg": "public/entry/右-三L门.webp",
    "floor1Img": "public/floor1/右-三L门.webp",
    "floor2Img": "public/floor2/右-三L门.webp",
    "remarks": "右侧入口，三个L形拐角墙体结构"
  },
  {
    "id": 13,
    "direction": "南",
  ...
  },
  {
    ...
    "direction": "南",
    "name": "南-orz门（新）",
    "entryImg": "public/entry/南-orz门.webp",
    "floor1Img": "public/floor1/南-orz门.webp",
    "floor2Img": "public/floor2/南-orz门.webp",
    "remarks": "南侧入口，墙体轮廓形似orz字形"
  },
  {
    "id": 17,
    "direction": "北",
  ...
  },
  {
    ...
    "direction": "北",
    "name": "北-4安全门（新）",
    "entryImg": "public/entry/北-4安全门.webp",
    "floor1Img": "public/floor1/北-4安全门.webp",
    "floor2Img": "public/floor2/北-4安全门.webp",
    "remarks": "北侧入口，北-4门变体，邻接安全门结构"
  }
];
...
function updateMapFloor() {
  ...
  // 地图一楼、二楼和全图地址
  // 全图路径由 floor1Img 推导，避免带“（新）”后缀的地图名与文件名不一致导致 404
  const imgUrl = currentFloor === "1" ? currentMap.floor1Img :
                 currentFloor === "2" ? currentMap.floor2Img :
                 currentMap.floor1Img.replace("/floor1/", "/full/");
